...
**15+ 终端和 IDE**：Terminal.app、Ghostty、Alacritty、iTerm2、WezTerm、Zellij、tmux、cmux、Kaku、VS Code、Cursor、Windsurf、Trae、JetBrains 全家桶（IDEA、WebStorm、PyCharm、GoLand、CLion、RubyMine、PhpStorm、Rider、RustRover）
...
| **Alacritty** | 完整 | Jump-back，激活 App；在 tmux 内支持 pane 定位 |
...
- **Terminal.app**、**Ghostty**、**Alacritty**、**cmux**、**Kaku**、**WezTerm**、**iTerm2** 和 **Zellij** — 完整的 jump-back 支持，带会话附着匹配（Alacritty 通过 App 激活，在 tmux 内支持 pane 定位；cmux 通过 Unix socket API；Kaku/WezTerm/Zellij 通过 CLI pane 定位；iTerm2 通过 AppleScript session/TTY 探针）
