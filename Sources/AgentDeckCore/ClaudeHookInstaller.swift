...
public struct ClaudeHookInstallerManifest: Equatable, Codable, Sendable {
    public static let fileName = "agent-deck-claude-hooks-install.json"
    public static let legacyFileName = "agent-deck-claude-hooks-install.json"
...
public enum ClaudeHookInstaller {
    ...
    private static func isManagedHook(_ hook: [String: Any], managedCommand: String?) -> Bool {
        ...
        return isLegacyAgentDeckHookCommand(command)
    }
    ...
    private static func isLegacyAgentDeckHookCommand(_ command: String) -> Bool {
        ...
        if (normalized.contains("agentdeckhooks") || normalized.contains("agentdeckhooks")) && normalized.contains("--source claude") {
            return true
        }

        return (normalized.contains("agent-deck-bridge") || normalized.contains("agent-deck-bridge"))
