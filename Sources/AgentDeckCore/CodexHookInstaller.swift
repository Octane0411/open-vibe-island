...
public struct CodexHookInstallerManifest: Equatable, Codable, Sendable {
    public static let fileName = "agent-deck-install.json"
    public static let legacyFileName = "agent-deck-install.json"
...
public enum CodexHookInstaller {
    ...
    public static let managedStatusMessage = "Managed by Agent Deck"
    public static let legacyManagedStatusMessage = "Managed by Agent Deck"
