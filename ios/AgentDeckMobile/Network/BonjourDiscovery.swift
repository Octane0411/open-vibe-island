...
/// Discovered Mac running Agent Deck.
...
/// Uses NWBrowser to discover macOS instances advertising `_agentdeck._tcp`.
@MainActor
final class BonjourDiscovery: ObservableObject {
    private static let logger = Logger(subsystem: "app.agentdeck.mobile", category: "BonjourDiscovery")
