...
final class ConnectionManager: ObservableObject {
    private static let logger = Logger(subsystem: "app.agentdeck.mobile", category: "ConnectionManager")
    ...
    @Published var notifyPermissions: Bool {
        didSet { UserDefaults.standard.set(notifyPermissions, forKey: "agentdeck.notify.permissions") }
    }
    @Published var notifyQuestions: Bool {
        didSet { UserDefaults.standard.set(notifyQuestions, forKey: "agentdeck.notify.questions") }
    }
    @Published var notifyCompletions: Bool {
        didSet { UserDefaults.standard.set(notifyCompletions, forKey: "agentdeck.notify.completions") }
    }
    @Published var silentCompletions: Bool {
        didSet { UserDefaults.standard.set(silentCompletions, forKey: "agentdeck.notify.silentCompletions") }
    }
    ...
    private var savedToken: String? {
        get { UserDefaults.standard.string(forKey: "agentdeck.token") }
        set { UserDefaults.standard.set(newValue, forKey: "agentdeck.token") }
    }
    private var savedMacName: String? {
        get { UserDefaults.standard.string(forKey: "agentdeck.macName") }
        set { UserDefaults.standard.set(newValue, forKey: "agentdeck.macName") }
    }
    var pairedAt: Date? {
        get {
            let interval = UserDefaults.standard.double(forKey: "agentdeck.pairedAt")
            return interval > 0 ? Date(timeIntervalSince1970: interval) : nil
        }
        set {
            if let date = newValue {
                UserDefaults.standard.set(date.timeIntervalSince1970, forKey: "agentdeck.pairedAt")
            } else {
                UserDefaults.standard.removeObject(forKey: "agentdeck.pairedAt")
            }
        }
    }
    ...
    init() {
        ...
        self.notifyPermissions = defaults.object(forKey: "agentdeck.notify.permissions") as? Bool ?? true
        self.notifyQuestions = defaults.object(forKey: "agentdeck.notify.questions") as? Bool ?? true
        self.notifyCompletions = defaults.object(forKey: "agentdeck.notify.completions") as? Bool ?? true
        self.silentCompletions = defaults.object(forKey: "agentdeck.notify.silentCompletions") as? Bool ?? false
    ...
    private func startNetworkMonitor() {
        ...
        monitor.start(queue: DispatchQueue(label: "app.agentdeck.mobile.network"))
